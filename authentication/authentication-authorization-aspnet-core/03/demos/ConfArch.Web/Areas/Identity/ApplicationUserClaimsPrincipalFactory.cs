...
namespace ConfArch.Web.Areas.Identity
{
        ...
        UserClaimsPrincipalFactory<ApplicationUser, IdentityRole>
    {
            ...
            GenerateClaimsAsync(ApplicationUser user)
        {
            ...
            identity.AddClaim(new Claim("Last Week",DateTime.Now.AddDays(-7).ToLongDateString()));
            identity.AddClaim(new Claim("Randomness",new Random(3).Next().ToString(),"string", "Math Random"));
